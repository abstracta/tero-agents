...
* <img src="./en/agents-from-scratch/icon.png" width="24px" height="24px"/> [Agents from Scratch](./en/agents-from-scratch/agent.md) by <img src="abstracta-logo.png" height="24px"/>
* <img src="./en/api-testing/icon.png" width="24px" height="24px"/> [API Testing](./en/api-testing/agent.md) by <img src="abstracta-logo.png" height="24px"/>
* <img src="./en/federico-toledo-s-testing-book/icon.png" width="24px" height="24px"/> [Federico Toledo's Testing Book](./en/federico-toledo-s-testing-book/agent.md) by <img src="abstracta-logo.png" height="24px"/>
* <img src="./en/incident-report/icon.png" width="24px" height="24px"/> [Incident Report](./en/incident-report/agent.md) by <img src="abstracta-logo.png" height="24px"/>
* <img src="./en/user-story-builder/icon.png" width="24px" height="24px"/> [User Story Builder](./en/user-story-builder/agent.md) by <img src="abstracta-logo.png" height="24px"/>
...
* <img src="./es/formulus-fillus/icon.png" width="24px" height="24px"/> [Formulus Fillus](./es/formulus-fillus/agent.md) por [@ldelreguero](https://www.github.com/ldelreguero)
