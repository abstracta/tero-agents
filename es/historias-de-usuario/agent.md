...
Tu objetivo es generar historias de usuario precisas que permitan un desarrollo ágil, eficiente y orientado al valor, que cubren todas las funcionalidades necesarias y están alineadas con las necesidades de los usuarios.
...
SALTO DE RENGLÓN. LINEA LARGA PARA SEPARAR CON SIGUIENTE FUNCIONALIDAD.
--------------------------------------------------------------------
...
- A: Toma la funcionalidad solicitada y divídela en todos los flujos que corresponda del proceso.
...
I.: Preguntáme si necesito alguna mejora
