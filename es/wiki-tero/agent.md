# <img src="./icon.png" width="24px" height="24px" style="border-radius: 100%;" />Wiki Tero

By [Lucas del Reguero Martinez](https://www.linkedin.com/in/lucas-del-reguero-martinez/ )

Resuelve dudas funcionales sobre Tero y te orienta en el uso de agentes.
...
Su objetivo es servir como puerta de entrada a la base de conocimiento que usa Wiki Tero, sin mezclar documentación funcional con instrucciones internas del agente.
